...
public enum DefenseChecklistItem {
    ...
    VISIT_MEDICAL_PROVIDER("진료 및 증빙 보관", "의료기관 진료 후 진료기록과 영수증을 보관하세요."),
    CHECK_WORK_ACCIDENT_COVERAGE("업무상 재해 적용 가능성 확인", "업무 또는 업무 관련 이동 중 발생했다면 근로복지공단에서 산재보험 적용 가능성을 확인하세요."),
    FOLLOW_TREATMENT_PLAN("치료 계획 확인", "예상 치료기간과 근무 가능 시점을 의료진과 확인하세요."),
    REVIEW_HEALTH_COVERAGE("보장 내역 확인", "가입한 건강보험·실손보험 등의 청구 가능 여부와 필요한 서류를 확인하세요."),
    SAVE_RESTRICTION_NOTICE("제한 통지 보관", "플랫폼이 보낸 이용 제한 사유와 통지 화면을 캡처해 보관하세요."),
    FILE_PLATFORM_APPEAL("플랫폼 이의제기 확인", "플랫폼 고객센터에서 이의제기 절차와 제출 기한을 확인하세요."),
    ...
    CHECK_DAMAGE_COVERAGE("손해 보장 확인", "자동차보험·장비보험·제조사 보증 등 적용 가능한 보장을 확인하세요."),
    ESTIMATE_CARE_PERIOD("돌봄 기간 확인", "집중 돌봄이 필요한 예상 기간과 다른 가족의 지원 가능 여부를 확인하세요."),
    CHECK_CARE_SUPPORT("돌봄 지원 확인", "지역 돌봄서비스와 가족돌봄 관련 지원제도의 이용 가능성을 확인하세요."),
