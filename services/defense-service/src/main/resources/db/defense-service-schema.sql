...
(
    ...
    calculation_status    VARCHAR(30) NOT NULL COMMENT 'CALCULATED, DIAGNOSIS_REQUIRED, EXPENSE_DATA_REQUIRED',
...
-- MySQL은 부분 유니크 인덱스를 지원하지 않으므로 사용자별 ACTIVE 중복은 서비스 트랜잭션에서 차단한다.
